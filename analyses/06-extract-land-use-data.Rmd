...
* OK so here is a bit of R weirdness, the `nc_open` code below will not run unless copy pasted into the console...*

```{r}
# Read in the netCDF data - copy paste into the terminal
